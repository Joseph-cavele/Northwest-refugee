 ...
 * (Backend/src/modules/notifications/email.service.js). Those paths are already sitting
...
export const PATHS = {
   ...
   * table (Backend/src/config/constants.js DASHBOARD_BY_ROLE) and sends the destination
