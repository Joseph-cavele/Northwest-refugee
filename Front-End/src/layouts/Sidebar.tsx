            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  {/*
                    * aria-current is what actually tells a screen reader which page this
                    * is. The blue is only a visual echo of it, and colour is never the
                    * sole signal for anything in this interface.
                    */}
